...
<div class="header-bot">
	<div class="container">
		<div class="col-md-3 header-left animated wow slideInLeft" data-wow-delay=".5s">
			<h1><a href="index.html"><img src="images/logo_new.png" alt="image" /></a></h1>
		</div>
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-left animated wow zoomIn" data-wow-delay=".5s">
			<h2><a href="index.html"><img src="images/logo_new.png" alt="image" style="width:186px;height:66px;"/></a></h2>
			<p>Neque porro quisquam est, qui dolorem ipsum quia dolor
		...
		<div class="clearfix"></div>
		<p class="copy-right animated wow zoomIn" data-wow-delay=".5s">&copy 2018 The Enginr Dot. All rights reserved </p>
	</div>
</div>
<!-- //footer -->
<!-- login -->
