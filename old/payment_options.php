...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
  ...
  <input type="hidden" name="business" value="bussinesstest@pandey.com">
  ...
  <input type="hidden" name="return" value="http://localhost:81/MyShop/paypal_success.php" />

	<input type="hidden" name="cancel_return" value="http://localhost:81/MyShop/paypal_cancel.php" />	

  
  <!-- Display the payment button. -->
  <input type="image" name="submit" border="0"
  src="http://www.worldclassps.com/images/PayPal-Pay-Now-Button.jpg"
